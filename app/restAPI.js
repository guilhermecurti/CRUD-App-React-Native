    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <Text>Buscando dados do URL da API</Text>
                <View>
                    <Text>Digite para ler os dados</Text>
                    <TextInput style={styles.input}         //Input trazer informacao
                        onChangeText={(text) => {
                                this.dataId = text
                        }}
                        value={this.dataId}
                    ...
                    <TextInput style={styles.input}         //Nome Input
                        ...
                        value={this.name}
                    />
                    <Text>Coloque seu endereço</Text>
                    <TextInput style={styles.input}         //Endereço Input
                        onChangeText={(text) => {
                                this.address = text
                        }}
                        value={this.address}
